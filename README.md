...
Kindly Consider the Flags which print the Debug Printf are only coded in the DEBUG_ build and DEBUG and not in the RUN mode, incase of any discrepancy 
...
Two configurations: <br />
    ...
    RUN Target - RUN Mode, no debug messages are printed on UART Terminal <br />
